...
<script lang="javascript">
	function pass(){
		...
		if( document.myForm["user.uname"].value =="" ){
			...
			alert("密码不能为空");
			pass = false;
		} else if(document.myForm["user.upassword"].value != document.myForm.upass1.value){
			alert("两次密码不一样");
			pass = false;
		}  else {
			pass = true;
		...
		<tr>
			...
			<td width="172">
				<table align="center">
					...
					<tr>
						<td><a href="login_form.jsp">用户登陆</a>
						</td>
					</tr>
				</table></td>
			...
			<td width="495">
				<form action="register" method="post" name="myForm"
					...
					<table align="center">
						...
						<tr>
							<td>密码：</td>
							<td><input type="password" name="user.upassword">
							</td>
						<tr>
						<tr>
							<td>重复密码：</td>
							<td><input type="password" name="upass1">
							</td>
						<tr>
							<td><input type="submit" value="注册" class="btn">&nbsp;</td>
							<td><input type="reset" value="重置" class="btn">
							</td>
						</tr>
					</table>
				</form></td>
