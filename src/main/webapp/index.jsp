...
<script language="javascript">var v = new Array(19);
var n = new Array(19);
v[0] = new Array('0');
n[0] = new Array('不限--');
...
<BODY BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0
	...
	<table width="780" border="0" align="center" cellpadding="0"
		...
		if( document.myForm["user.uname"].value =="" ){
			alert("用户名不能为空");
			return false;
		}else if(document.myForm["user.upassword"].value == ""){
			alert("密码不能为空");
			return false;
		} else {
			return true;
...
-->
				...
				<form action="login" method="post" name="myForm"
					...
					<table align="center">
						...
						<tr>
							<td colspan="2"><input type="text" name="user.uname" size=10
								" class="editbox"></td>
						</tr>
						<tr>
							<td colspan="2">密&nbsp;&nbsp;码：</td>
						...
						<tr>
							<td colspan="2"><input type="password" name="user.upassword"
								size=10 "  class='editbox'></td>
						</tr>
						<tr>
							<td><input type="hidden" name="sign" value="login" /> <input
								type="submit" value="登陆" class='btn'> <input
					...
					<table width="88%;" id="advSearch"
						...
						<tr>
							...
							<td><input type="checkbox">地下室 <input
								type="checkbox">平房 <input type="checkbox">普通住宅 <input
								type="checkbox">公寓 <input type="checkbox">别墅</td>
						</tr>
						<tr>
							<td>发布日期：</td>
					...
					<table width="88%" cellspacing="0">
						...
						<c:forEach items="${houseList}" var="house">
							...
							<tr>
								...
								<td align='center' style='height:30px;'>${houst.rent }元</td>
								<td align='center'>${house.datetime }</td>
							</tr>
